	...
	<form name="f2" method="get">
		<fieldset>
			...
			<label for="clave">Password</label><input type="password"
				name="clave" /><br /> <label for="ocultoVacio">Oculto vac&iacute;o</label><input
				type="hidden" name="ocultoVacio" /><br /> <label for="ocultoLleno">Oculto
				lleno</label><input type="hidden" name="ocultoLleno"
				value="sorpresa" /><br /> <input type="submit" value="Enviar datos" />
		</fieldset>
	</form>
	...
	<form name="f4" method="get">
		<fieldset>
			...
			<label for="radioVerde">Verde</label><input type="radio"
				name="radioVerde" id="radioVerde" /><label for="radioNaranja">Naranja</label><input
				type="radio" name="radioNaranja" id="radioNaranja" /><label
	...
	<form name="f5" method="get">
		<fieldset>
			...
			<label for="radioGenero">Mujer</label><input type="radio"
				name="genero" id="genero" /><label for="radioGenero">Hombre</label><input
				type="radio" name="genero" id="genero" /><label for="radioGenero">Otro</label><input
				type="radio" name="genero" id="genero" /><br /> <input type="submit"
				value="Enviar datos" />
		</fieldset>
	</form>
